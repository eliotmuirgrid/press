...
o many programmers just get bored. They want to invent or learn a sexy new language. I might do that too, but I wouldn’t start from scratch. I would merely remove a lot of functionality from C++ to discourage people from using features I see as having no value. The best way to improve most systems is to remove functionality.
