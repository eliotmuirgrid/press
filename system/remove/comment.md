...
There's an analogy here. Think of **gender affirming healthcare**. The intent of the 'code' here is to do the impossible. Change the gender of a human being, which was determined deep at the point of conception in the most fundamental code of all – DNA. Making a hole or appending something and calling it something it isn't doesn't alter what the procedure has actually done. You cannot "patch" something without altering the deep system code, which is gender.

Maybe one day will be able to truly fix 'gender'.  But that day is not today.

Back to code.  I got ChatGPT to produce the first cut of a comment remover.  All well
