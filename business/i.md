...
It's difficult. Let's look at the problems.

## The Problems with a Traditional Model
...
This is just a tough problem to solve, and it does not work well with a large team. The team needs to be as small as possible.

## The New Model – Open and Trust-Based
...
We are facing an existential challenge with our global IT infrastructure. We are in the early stages of the storm. Attackers on IT infrastructure will get exponentially more capable. That means any imperfection in infrastructure software **can and will be exploited**.

That is my vision moving forward.
...
My distributed organization will be ready to help. We will have built resilient, simple technology solutions that can be quickly deployed to set up emergency infrastructure—because we are solving our own infrastructure problems using our own technology.

Everything—including billing—will be ready when the time comes.

I will understand the personal hell you are experiencing. When you are working 80 hours with no sleep and your family is collapsing under the strain, my unconventional distributed organization will be your oxygen line. I am the only credible technology leader talking seriously about the challenges that will need to be solved.

You might prefer to pretend that this time will never come, but my hand will be ready to reach out to you when, inevitably, it does.
...
All customers are entitled to ask for a customer ID. The best way is to reach out via WhatsApp or iMessage at +1 345 325 1240. You will receive a customer ID.

This customer ID will allow you to generate all the license codes you need while the business is transformed into a new, much leaner model of delivery.
