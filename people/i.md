...
It turned out to be the best business decision ever. The business (no longer a company in the traditional sense) has been greatly improved.  It's turned out to a much lower stress organization to manage, more efficient and agile and able to have a much larger impact.  Many of our clients have been asking how we did it and if we could help them transform their organizations in the same way.  That has been a significant part of how we grow our relationships with our clients to help them too realize the same efficinticies that can be a achieved using the the [Theory of Constraints](/system/toc) and [systems thinking](/system).
