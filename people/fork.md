...
- Find the markdown (`.md`) file with your name, or the one where Eliot besmirched your reputation.
- Make your changes: correct mistakes, remove slander, add “cool dude” to your bio.
- Save!
...
> _Reminder: If the “backend” is just a folder of markdown files, you don’t need a PhD—just basic reading, typing, and the ability to admit Eliot made a mistake (which he does, regularly)._
